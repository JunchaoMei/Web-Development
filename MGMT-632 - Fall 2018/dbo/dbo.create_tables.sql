ALTER PROCEDURE [dbo].[create_tables]
AS
...
[lName] VARCHAR(20) NOT NULL, [phone] VARCHAR(10) NULL,
[dob] DATE NULL, 
...
[prodHeadline] VARCHAR(200) NOT NULL, 
...
CONSTRAINT [PK_prodID] PRIMARY KEY CLUSTERED ([prodID] ASC), CONSTRAINT [FK_catID] FOREIGN KEY (catID) REFERENCES category(catID) ON DELETE CASCADE
);

CREATE TABLE [dbo].[orders] (
[OID] INT IDENTITY(1,1) PRIMARY KEY, 
[custID] INT NULL,
[visitorID] VARCHAR(15) NULL,
[createDt] DATE NULL, 
[orderDt] DATE NULL, 
[shipID] INT NULL, 
...
CONSTRAINT [FK_upSellcustID] FOREIGN KEY (custID) REFERENCES customer(custID) ON DELETE CASCADE,
CONSTRAINT [FK_upSellprodID] FOREIGN KEY (prodID) REFERENCES product(prodID) ON DELETE CASCADE
);
